# This custom script is designed to take a data export from PowerSchool and
# import it into Google.  There are no expressed warrenties, use this
...
# House cleaning, move files to storage locations.

# Rename log file with today's date in the new name and move log file to log folder
new_name = "Student_Import"+plainday+".log"
rename("Student_Import.log", new_name)
shutil.move(new_name,"/Users/admin/bin/gam/logs/")

# Rename and move the datafile into a folder
new_datafile = "studentAccounts"+plainday+".csv"
rename("studentAccounts.csv", new_datafile)
shutil.move (new_datafile,"/Users/admin/bin/gam/datafiles/" )
